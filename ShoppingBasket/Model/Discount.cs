...
namespace ShoppingBasket.Model
{
    public abstract class Discount : IDiscount
    {
        ...
        public abstract decimal CalculateDiscount(IProduct product, out string message);
    ...
    public class ValueDiscount : Discount
    {
        ...
        public override decimal CalculateDiscount(IProduct product, out string message)
        {
    ...
    {
        public MixtValueDiscount(string productId, decimal value, IDiscountRule rule) : base(productId, value)
        {
            Rule = rule;
        }

        public IDiscountRule Rule { get; set; }
    }
